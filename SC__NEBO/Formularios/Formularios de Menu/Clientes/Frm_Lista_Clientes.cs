    ...
    public partial class Frm_Lista_Clientes : Form
    {
        ...
        private void DgvData_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (DgvData.Rows.Count > 0)
            {
                ...
                Formularios.Formularios_de_Menu.Prestamos.Frm_Prestamos prestamos = new Prestamos.Frm_Prestamos();
                prestamos = ((Formularios.Formularios_de_Menu.Prestamos.Frm_Prestamos)Owner);
